...
$(function() {
  ...
  if(!isMobile()) {
    ...
    document.getElementById('diver-ascent').style.display = 'block';
    document.getElementById('diver-ascent').style.top = '330px';
    document.getElementById('diver-descent').style.display = 'none';
    document.getElementById('diver-descent').style.top = '330px';
    ...
    function diverTracking(e) {
      var ascentDiver = document.getElementById('diver-ascent');
      var descentDiver = document.getElementById('diver-descent');

      if(e.clientY >= 330 && e.clientY <= (window.innerHeight - 230)) {
        // Ascending
